...
namespace ServicioComunicacionModel.DAL
{
    public class MedidorConsumoDALArchivos : IMedidorConsumoDAL
    {
        ...
        public List<MedidorConsumo> ObtenerMedidores()
        {
            ...
            MedidorConsumo m1 = new MedidorConsumo(1, 5555);
            MedidorConsumo m2 = new MedidorConsumo(2, 6666);
            MedidorConsumo m3 = new MedidorConsumo(3, 7777);
            MedidorConsumo m4 = new MedidorConsumo(4, 8888);
